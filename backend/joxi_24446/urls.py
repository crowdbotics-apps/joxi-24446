...
admin.site.site_header = "joxi"
admin.site.site_title = "joxi Admin Portal"
admin.site.index_title = "joxi Admin"

# swagger
api_info = openapi.Info(
    title="joxi API",
    default_version="v1",
    description="API documentation for joxi App",
)
